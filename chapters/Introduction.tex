...
Basic idea is to select a basis algorithm. Abstrify away concretness of implementation to support flexibility. Use the flexibility to substitute concretness with parallel implementations.
