...
\emph{Extender} can be parallelized by using MapReduce concepts\cite{MapReduce,SteeleFold,Doe09}. We use Clojure\cite{clojure} reducers library to show how this can be implemented.
