    ...
    \Function{Visit}{graph, start, fn, examine?}
        ...
        \Spawn
            \While{$true$}
                ...
                \If{ $terminate$ }
                    \State added.signal() \Comment{let next worker through}
                    \State mutex.unlock()
                    \State{\textbf{break}}
                \EndIf
                \Let{$node$}{$unvisited$.take()} \Comment{}
