\begin{tikzpicture}[auto]
	...
	\node[query](c) at (8.5,-2.1) {c};
	\node[query](g) at (8.5,-2.7) {g};

	\tikzstyle{tx} = [ ->, thick, dashed, bend right, color=black ];
	\tikzstyle{ta} = [ ->, thick, dotted, bend left, color=red ];
	\tikzstyle{tc} = [ ->, thick, dotted, bend left, color=blue ];
	\tikzstyle{tg} = [ ->, thick, dotted, bend left, color=green ];
